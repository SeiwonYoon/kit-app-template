...
class TbsUsdWindow:
    ...
    def __init__(
        ...
        *,
        ...
        self._viewport = TbsViewport(self._master.context_name)
    ...
    def show(self) -> None:
        ...
        with self._window.frame:
            with ui.VStack(spacing=6):
                ...
                cf_diag = ui.CollapsableFrame("진단", collapsed=True, height=0)
                with cf_diag:
                    with ui.HStack(spacing=4, height=24):
    ...
    def _on_force_dedicated_viewport(self) -> None:
        ...
        self._log(f"Viewport 강제 열기 {'OK' if ok else 'FAIL'} | {self._viewport.status_text()}")
    ...
    def _on_open_master(self) -> None:
        ...
        from .tbs_usd_path import master_usd_path_is_openable
    ...
    def _refresh_instances(self) -> None:
        ...
        try:
            from .tbs_asset_diagnostics import kind_to_user_label
    ...
    def _on_bake_instance(self, prim_path: str) -> None:
        ...
        if not raw:
            try:
                from .tbs_extract_from_master import _discover_asset_path_from_master
        ...
        from .tbs_bake_omnigraph import (
    ...
    def _on_copy_timesamples_instance(self, prim_path: str) -> None:
        ...
        from .tbs_asset_diagnostics import kind_to_user_label
        from .tbs_types import ASSET_KIND_OMNIGRAPH, ASSET_KIND_STATIC
