...
- `TBS_FIXED_FPS` (30) 로 timeCode↔초 변환 고정 — 자산 tps 와 무관하게 LAM 전역 정책.
...
LAM_FIXED_FPS = TBS_FIXED_FPS  # ported LAM code alias
...
class AnimationInstance:
    ...
    참고: `asset_tps` 는 `__post_init__` 에서 **항상 `TBS_FIXED_FPS`(=30)** 로 정규화된다.
