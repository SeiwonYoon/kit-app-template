...
# 패널 레이아웃 — 크기·색·테두리·가로선·패딩 SSOT: ``lam_sim_control_defaults``
...
try:
    ...
    STATUS_PANEL_WIDTH_PX = 270  # type: ignore
    STATUS_PANEL_HEIGHT_PX = 0  # type: ignore
    STATUS_PANEL_LABEL_COL_WIDTH_PX = 80  # type: ignore
    STATUS_PANEL_ROW_HEIGHT_PX = 26  # type: ignore
    STATUS_PANEL_TIME_ROW_HEIGHT_PX = 56  # type: ignore
    STATUS_PANEL_STATE_ROW_HEIGHT_PX = 72  # type: ignore
    STATUS_PANEL_PADDING_PX = 10  # type: ignore
    STATUS_PANEL_CONTENT_PADDING_PX = 10  # type: ignore
    STATUS_PANEL_BG_COLOR_HEX = 0xFFFFFFFF  # type: ignore
    STATUS_PANEL_BORDER_COLOR_HEX = 0x00000000  # type: ignore
    STATUS_PANEL_ROW_BG_HEX = 0xFFFFFFFF  # type: ignore
    STATUS_PANEL_TEXT_COLOR_HEX = 0xFF000000  # type: ignore
    STATUS_PANEL_LABEL_COLOR_HEX = 0xFF000000  # type: ignore
    STATUS_PANEL_BORDER_WIDTH = 0  # type: ignore
    STATUS_PANEL_TABLE_BORDER_WIDTH = 0  # type: ignore
    STATUS_PANEL_BORDER_RADIUS = 0  # type: ignore
    STATUS_PANEL_ROW_SEP_COLOR_HEX = 0xFFB0B0B0  # type: ignore
    STATUS_PANEL_ROW_SEP_HEIGHT_PX = 2  # type: ignore
    STATUS_PANEL_ROW_SEP_INSET_PX = 10  # type: ignore
...
# PM1~PM5 / Airlock 강조 시 3D 기기 라벨 배경 (시뮬·평면도 occupancy 와 독립)
